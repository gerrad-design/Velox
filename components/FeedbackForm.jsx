...
export default function FeedbackForm({ onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 shadow-xl flex items-center justify-center bg-black/30 backdrop-blur-sm">
      <form onSubmit={handleSubmit} className="space-y-4 bg-white dark:bg-black p-6 rounded-lg shadow-xl w-[400px] relative">
        ...
        <button type="submit" className="bg-white text-black px-6 py-2 rounded w-full border border-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 dark:border-gray-600">
          Submit Feedback
        </button>
      </form>
    </div>
